...
const UniversityCard: React.FC<UniversityCardProps> = ({ university, onSearchRequirements }) => {
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-lg p-5 flex flex-col justify-between h-full border border-white/10 hover:border-sky-500/50 transition-all duration-300 hover:shadow-sky-500/10 hover:-translate-y-1">
      <div>
